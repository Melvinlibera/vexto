...
CREATE TABLE IF NOT EXISTS users (
    ...
    tipo_usuario ENUM('usuario', 'compania', 'admin') DEFAULT 'usuario',
...
-- Insertar usuario administrador: admin / 569246
INSERT IGNORE INTO users (nombre, apellido, genero, cedula, rnc, telefono, email, password, tipo_usuario, max_propiedades, bio, rating, total_reviews, verified)
VALUES (
    'Admin',
    'Vexto',
    'Masculino',
    ...
    '+1-809-000-0000',
    'admin@vexto.com',
    '$2y$10$kqLxKBqJzqJzqJzqJzqJzOJzqJzqJzqJzqJzqJzqJzqJzqJzqJzqJ',
    'admin',
    100,
