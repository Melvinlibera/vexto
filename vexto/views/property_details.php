...
?>
<link rel="stylesheet" href="<?php echo ASSETS_URL; ?>css/gallery.css">
<?php
...
<div class="main-container" style="flex-direction: column; max-width: 1200px; margin: 40px auto;">
    ...
    ?>
    <div class="property-img-container" data-gallery style="height: 550px; border-radius: 32px; margin-bottom: 40px; box-shadow: var(--shadow-lg); position: relative; overflow: hidden;">
        <span class="op-badge" style="font-size: 1rem; padding: 10px 25px; border-radius: 12px; z-index: 2; position: absolute; top: 20px; left: 20px;">
            <?php echo $prop['tipo_operacion']; ?>
        </span>
        <img src="<?php echo htmlspecialchars($imageSrc); ?>" class="property-img" data-zoomable alt="Propiedad" style="cursor: zoom-in;">
        <span style="position: absolute; bottom: 20px; right: 20px; background: rgba(0,0,0,0.65); color: #fff; padding: 10px 14px; border-radius: 999px; font-size: 0.9rem; z-index: 2;">Haga clic para ampliar</span>
    </div>
...
<script src="<?php echo ASSETS_URL; ?>js/image-gallery.js"></script>
