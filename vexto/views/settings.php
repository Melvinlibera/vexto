                        ...
                        <div style="display: flex; align-items: center; justify-content: space-between; gap: 16px;">
                            <div style="display: flex; align-items: center; gap: 15px;">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 0.85rem; color: var(--muted-text);">Activa el sello de confianza por $10 dólares.</div>
                                </div>
                            </div>
                            <?php if ($user_data['verified']): ?>
                                <span style="color: #059669; font-weight: 800; font-size: 0.9rem;"><i class="fas fa-check"></i> ACTIVO</span>
                            <?php else: ?>
                                <label class="switch" style="position: relative; display: inline-flex; align-items: center; gap: 12px; cursor: pointer;">
                                    <span style="font-size: 0.9rem; font-weight: 700; color: var(--text-color);">Comprar Validación</span>
                                    <input type="checkbox" id="buy_validation" name="buy_validation" value="1" style="opacity: 0; width: 0; height: 0; position: absolute;">
                                    <span class="slider" style="position: relative; display: inline-block; width: 54px; height: 30px; background-color: #ccc; border-radius: 30px; transition: .4s;"></span>
                                </label>
                            <?php endif; ?>
                        </div>
                    </div>
