...
<header>
    ...
    <div class="nav-actions">
        ...
        <?php if ($user): ?>
            ...
            <a href="<?php echo BASE_URL; ?>views/feedback.php"><i class="fas fa-comment-dots"></i> Feedback</a>
            <a href="<?php echo BASE_URL; ?>views/settings.php"><i class="fas fa-user-circle"></i> Perfil</a>
            <?php if ($user['tipo_usuario'] == 'admin'): ?>
                <a href="<?php echo BASE_URL; ?>views/admin_dashboard.php"><i class="fas fa-user-shield"></i> Admin</a>
            <?php elseif ($user['tipo_usuario'] == 'compania'): ?>
